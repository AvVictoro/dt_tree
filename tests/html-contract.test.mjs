...
test('shell exposes the legacy catalog and four catalog variants', async () => {
  ...
  assert.deepEqual(navigation, ['home', 'catalog', 'catalog-1', 'catalog-2', 'catalog-3', 'catalog-4']);
  for (const view of ['catalog-1', 'catalog-2', 'catalog-3', 'catalog-4', 'catalog-indicator']) {
...
test('new catalog module does not intercept or render the legacy catalog', async () => {
  ...
  assert.match(source, /\['catalog-1', 'catalog-2', 'catalog-3', 'catalog-4'\]/);
