...
- автономный переносимый набор из 3 000 реальных индикаторов — по 200 на каждый из 15 блоков.
...
Команда ниже использует только локальные архивы. Рекомендуемое значение `--per-block 200` даёт переносимый набор из 3 000 строк; его можно увеличить при наличии допустимого размера сборки.
