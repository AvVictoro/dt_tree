...
- шесть основных разделов: «Дом», исходный «Каталог» и четыре экспериментальных варианта «Каталог 1–4»;
- исходный «Каталог» сохранён без изменений и работает независимо от экспериментального модуля;
- единый API, модель карточки, поиск, фасеты и URL-состояние для четырёх новых вариантов;
...
- автономный максимально расширенный набор из 65 123 реальных индикаторов: до 5 000 первичных рядов на каждый блок, а для меньших блоков — все доступные.
...
Команда ниже использует только локальные архивы. Значение `--per-block 5000` даёт максимально широкий проверенный файловый набор из 65 123 строк. Сжатый файл занимает около 11 МБ; полный набор проходит локальную проверку API и интерфейса.
