...
Команда ниже использует только локальные архивы. Значение `--per-block 7500` даёт максимально широкий проверенный файловый набор из 94 232 строк. Сжатый файл занимает около 16 МБ; полный набор проходит локальную проверку API и интерфейса.
